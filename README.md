...
• Develop awareness and training materials to reduce risky user behavior.
...
• 2_Access_Control_Policy.docx – Role-based access control, monitoring, and alert thresholds.
• 3_Employee_Training_Materials
  o 3.a_Awareness_Flyer.pdf
  o 3.b_Checklist_for_Safe_Data_Handling.txt
• 4_Incident_Response_Playbook.docx – Detection, investigation, and recovery steps.
• 5_Anomaly_Detection_Analytics.xlsx – Synthetic log data and anomaly scoring model.
• visual
...
• RBAC model, separation of duties, logging requirements, and alert response responsibilities.

Employee Training Materials (PDF/TXT)
• Awareness flyer showing how insiders cause harm.
• Checklist for safe data handling and reporting suspicious activity.
